    ...
    <div class="row">
        ...
        <form action="index.php" method="POST">
            <div class="form-group">
                ...
                <input class="form-group" type="number" name="no_ktp" id="no_ktp">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input class="form-group" type="text" name="alamat" id="alamat_lengkap">
            </div>
            <div class="form-group">
                <label for="no_hp">Nomor HP</label>
                <input class="form-group" type="number" name="no_hp" id="no_hp">
            </div>
